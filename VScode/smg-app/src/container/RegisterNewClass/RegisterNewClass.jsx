...
import { createClass, getSchoolGrades } from '../../database';
...
const RegisterNewClass = () => {
    ...
    useEffect(() => {
        getSchoolGrades(schoolId, setSchoolGrades);
    }, []);
...
*/
    ...
    const [schoolId, setSchoolId] = useState('2');//should change according to login details
...
*/      
  ...
  return (
    <div className="container">
        ...
        <Navbar title="Register New Class" previous="/createnewmap"/>
